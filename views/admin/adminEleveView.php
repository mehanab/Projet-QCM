			...
			<article class="d-flex flex-column col-lg-9 card bg-dark text-white py-5 ml-lg-2">
				...
				<?php else: ?>
						...
						<header class="card-header">
							<h3 class="d-flex justify-content-center my-4">Insérez les coordonnées de l'élève </h3>
						</header>
					...
					<form action="adminAddEleve" method="post"  class="col-lg-8 d-flex flex-column align-self-center card-body formulaire needs-validation" novalidate>
						...
						<div class="form-group row">
							...
							<input id="pseudo" type="text" name="pseudo" class="col-sm-10 form-control" value="<?= $_POST['pseudo']?? ''?>" placeholder="Pseudo de l'élève" required>
							<div class="invalid-feedback">
						...
						<div class="form-group row">
							      ...
							      <select id="inputClasse" class="col-sm-8 form-control" name="id_classe"required>
							      	...
							      	<?php if(isset($classes)): ?>
								        ...
								        <option value="<?= $classe->getId(); ?>"><?= $classe->getLibelle(); ?></option>
								   		<?php endforeach ?>
								    <?php endif ?>
							      </select>
							      <div class="invalid-feedback">
						...
						<h3> <span> Adresse de l'élève </span> </h3>
