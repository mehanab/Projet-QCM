				...
				<div class="media pt-4">
					...
					<div class="media-body pt-0">
						<?php if(isset($_SESSION['professeur'])): ?>
							<ul>
								<li class="nav-link">Nom : <strong><?= $_SESSION['professeur']['nom'] ?></strong></li>
								<li class="nav-link">Prenom : <strong><?= $_SESSION['professeur']['prenom'] ?></strong></li>
								<li class="nav-link">Sexe : <strong><?= $_SESSION['professeur']['sexe'] ?></strong></li>
								<li class="nav-link">Date de naissance : <strong><?= date('d-m-Y', strtotime($_SESSION['professeur']['date_de_naissance'])); ?></strong></li>
								<li class="nav-link">Email : <strong><?= $_SESSION['professeur']['mail']; ?></strong></li>
								<li class="nav-link">Pseudo : <strong><?= $_SESSION['professeur']['pseudo']; ?></strong></li>
					...
					<div class="modal-dialog">
					    <div class="modal-content">
						      ...
						      <div class="modal-body">
							        <form action="/professeur/confirmer_password" method="Post">
								          <div class="mb-3">
...
<script src="/js/professeur/professeurMonCompte.js?v=<?= time() ?>"></script>
